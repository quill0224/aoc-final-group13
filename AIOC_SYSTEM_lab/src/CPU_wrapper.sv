...
//AR_M1訊號控制
wire is_non_cacheable = (araddr_DM[31:16] == 16'h0005) || (araddr_DM[31:16] == 16'h1001) || (araddr_DM[31:16] == 16'h1002);
assign ARID_M1 = 4'd0;
always @(posedge ACLK or posedge rst) begin
    if (rst) begin
        araddr_DM <= 32'd0;
...
assign ARADDR_M1 = is_non_cacheable ? araddr_DM : D_addr;
assign ARLEN_M1  = is_non_cacheable ? 4'd0 : (DM_inst_type == 2'b11)?4'd0:(DM_inst_type == 2'b10)?4'd3:4'd0;
