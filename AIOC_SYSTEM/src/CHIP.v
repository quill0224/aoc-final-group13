...
wire [   31:0] DRAM_Q_i; // up

wire [   31:0] ROM_out_i; // right

wire           ROM_read_o; // left
wire           ROM_enable_o; // left
wire [   11:0] ROM_address_o; // left
wire           DRAM_CSn_o; // left
wire [    3:0] DRAM_WEn_o; // left
wire           DRAM_RASn_o; // left
wire           DRAM_CASn_o; // left
wire [   10:0] DRAM_A_o; // left 
wire           DRAM_valid_i; // left

wire [   31:0] DRAM_D_o; // bottom
...
// // wire DRAM_valid_i; // left
// PDCDG_H ipad_DRAM_valid (.OEN(1'b1), .IE(1'b1), .I(1'b0), .PAD(DRAM_valid), .C(DRAM_valid_i)); ///ROM_out
